...
class __TwigTemplate_55cdf590abab4a3fc8ab5dde917c26bc588b9abcf22ed9aff6c02190f958b077 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 21
        echo " ";
        if ((twig_get_attribute($this->env, $this->source, twig_first($this->env, twig_get_attribute($this->env, $this->source, (($__internal_compile_0 = twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_slide_type", [], "any", false, false, true, 21)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["#items"] ?? null) : null), "getValue", [], "method", false, false, true, 21)), "value", [], "any", false, false, true, 21) == "slide")) {
            echo " 
...
\t</div>
 ";
        } elseif ((twig_get_attribute($this->env, $this->source, twig_first($this->env, twig_get_attribute($this->env, $this->source, (($__internal_compile_1 = twig_get_attribute($this->env, $this->source,         // line 25
($context["content"] ?? null), "field_slide_type", [], "any", false, false, true, 25)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["#items"] ?? null) : null), "getValue", [], "method", false, false, true, 25)), "value", [], "any", false, false, true, 25) == "image")) {
            echo " 
...
\t</div>
 ";
    ...
    {
        return new Source("", "themes/martis/templates/block/block--slider.html.twig", "/Users/hamad/WebServer/dominic/themes/martis/templates/block/block--slider.html.twig");
    }
